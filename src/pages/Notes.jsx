...
export default function Notes(){
    ...
    const handleEditClick = (note) => {
        ...
        setDataForm({
            ...
            status: note.status || "",  // sesuaikan kalau ada status
        });
        };
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                    ...
                    >
                    {loading ? "Mohon Tunggu..." : isEdit ? "Update Catatan" : "Tambah Catatan"}
                    </button>
                ...
                <GenericTable
                    ...
                    renderRow={(note, index) => (
                        <>
                            ...
                            <td className="px-6 py-4 max-w-xs flex space-x-3">
                                <button
                                    onClick={() => handleEditClick(note)}
                                    disabled={loading}
                                    className="text-blue-500 text-2xl hover:text-blue-700 transition-colors"
                                >
                                    ✏️ {/* Bisa diganti pakai icon edit */}
                                </button>
                                <button
                                    onClick={() => handleDelete(note.id)}
                                    disabled={loading}
                                    className="text-red-400 text-2xl hover:text-red-600 transition-colors"
                                >
                                    <AiFillDelete />
                                </button>
                                </td>
